      ...
      <div ref={slider} className="carousel-wrapper">
        <section className="main-carousel panel carol-bg1">
          ...
          <div className="grid-3">
            <div className="pic-1">
              <Image src={car2}alt="random"  />
            </div>
            <div className="pic-2">
              <Image src={car1}alt="random"  />
            </div>
            <div className="pic-3">
              <Image src={car3} alt="random" />
            </div>
          </div>
        </section>
